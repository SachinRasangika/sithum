  ...
  return (
    <nav className={`navbar${scrolled ? ' is-scrolled' : ''}`} role="navigation" aria-label="Main Navigation">
        ...
        <div className="navbar-top-content">
          <div className="navbar-left">
            ...
            <div className="logo-container">
              ...
              <img
                src="https://api.builder.io/api/v1/image/assets/TEMP/5b738baa78f384112d92ce88d18afb73a906d014?width=84"
                alt="Brand Logo"
                className="main-logo"
              />
            </div>
          ...
          <div className="navbar-right">
            ...
            <a href="#about" className="enquire-button">
              <span>Enquire</span>
              <svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><g clipPath="url(#clip0_103_947)"><path d="M20.5544 39.2581C30.8637 39.2581 39.221 30.9008 39.221 20.5915C39.221 10.2822 30.8637 1.9248 20.5544 1.9248C10.245 1.9248 1.8877 10.2822 1.8877 20.5915C1.8877 30.9008 10.245 39.2581 20.5544 39.2581Z" stroke="#030D34" strokeWidth="2.66667" strokeLinecap="round" strokeDasharray="0.13 5.33"/><path d="M20.3642 13.9248V27.2581M20.3642 27.2581L24.5547 23.5544M20.3642 27.2581L16.5547 23.5544" stroke="#030922" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round"/></g><defs><clipPath id="clip0_103_947"><rect width="40" height="40" fill="white" transform="translate(0.554688 0.591797)"/></clipPath></defs></svg>
            </a>
          </div>
        </div>
      </div>
      ...
      <aside id="mobile-drawer" ref={drawerRef} className={`mobile-drawer${menuOpen ? ' is-open' : ''}`} aria-hidden={!menuOpen}>
        ...
        <a href="#about" className="drawer-cta" onClick={() => setMenuOpen(false)}>Enquire</a>
      </aside>
    </nav>
  );
}
